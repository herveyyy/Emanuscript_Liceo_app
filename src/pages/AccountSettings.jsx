        ...
        <div className="border-t mt-2.5 border-gray-400 h-1 w-full"></div>
                ...
                <div className="flex flex-wrap mb-8 w-full justify-center md:justify-normal md:w-[40rem]">
                    ...
                    <div className="w-[8rem] py-1 px-3 mt-4">
                        <select className="block appearance-none w-full bg-maroon-800 border border-gray-300 text-gray-100 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-red-900 focus:border-gray-500 text-center" id="grid-suffix">
                    ...
                    <div className="relative">
                        <select
                        disabled className="block appearance-none w-full bg-maroon-800 border border-gray-300 text-gray-100 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-red-900 focus:border-gray-500" id="grid-department">
                    ...
                    <div className="relative">
                        <select 
                        disabled
                        className="block appearance-none w-full bg-maroon-800 border border-gray-300 text-gray-100 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-maroon-900 focus:border-gray-500" id="grid-course">
