  ...
  return (
    <div className="flex justify-center mt-6">
      <div className="absolute flex justify-center items-center mb-[20rem] px-1">
        <div className="bg-maroon-900 rounded-full flex justify-center mb-[1rem] py-1 px-1">
      ...
      <div className="flex-col mt-32 border-t sm:border-t-0 border-maroon-800 w-full ">
          ...
          <div className="flex flex-wrap mb-8 w-full justify-center md:justify-normal md:w-[40rem]">
            <div className="w-full md:w-1/2 px-3 md:mb-0 text-center md:text-left ">
              ...
              <div className="flex w-full justify-center md:block">
                <input
                  className="appearance-none block w-[15rem] bg-gray-100 text-gray-700 border border-red-900 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                  id="grid-first-name"
                  type="text"
            ...
            <div className="w-full md:w-1/2 px-3 mb-4 text-center md:text-left">
              ...
              <div className="flex w-full justify-center md:block">
                <input
                  className="appearance-none block w-[15rem] bg-gray-200 text-gray-700 border
                     border-maroon-900 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white
            ...
            <div className="w-[8rem] py-1 px-3 mt-4">
              <select
                className="block appearance-none w-full bg-maroon-800 border border-gray-300 text-gray-100 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-red-900 focus:border-gray-500 text-center"
                id="grid-suffix"
              >
            ...
            <div className="w-full md:w-1/2 px-3 mb-4 text-center md:text-left">
              ...
              <div className="flex w-full justify-center md:block">
                <input
                  className="appearance-none block w-[15rem]
                     bg-gray-200 text-gray-700 border border-maroon-900 
            ...
            <div className="w-full md:w-1/2 px-3 mb-4 text-center md:text-left">
              ...
              <div className="flex w-full justify-center md:block">
                <input
                  className="appearance-none block w-[15rem] 
                    bg-gray-200 text-gray-700 border border-maroon-900 rounded
            ...
            <div className="flex gap-5 mb-4 w-86 items-center flex-wrap">
              ...
              <div className=" flex items-center">
                <p className="text-gray-700 uppercase">Others:</p>
                {genderOtherChecker(user.gender) ?? (
            ...
            <div className="flex flex-wrap -mx-3 mb-2 w-full md:w-[40rem] mt-2">
              <div className="w-full sm:w-1/2 px-3  md:mb-0">
                ...
                <div className="relative">
                  <select
                    disabled
                    className="block appearance-none w-full bg-maroon-800 border border-gray-300 text-gray-100 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-red-900 focus:border-gray-500"
                    id="grid-department"
                  >
              ...
              <div className="w-full sm:w-1/2 px-3 md:mb-0">
                ...
                <div className="relative">
                  <select
                    disabled
                    className="block appearance-none w-full bg-maroon-800 border border-gray-300 text-gray-100 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-maroon-900 focus:border-gray-500"
                    id="grid-course"
                  >
