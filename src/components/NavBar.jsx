...
function NavBar() {
    return (  
        <div className="flex justify-between py-1 mt-3">
            <div className="flex justify-start w-14 max-h-14 bg-red-900 rounded-md ml-[2rem]">
                <img src="static/images/libraryLogo.png"/>
            </div>
            <div className="bg-red-900 rounded-md mb-7 px-3 py-1 mr-[2rem]">
                <ul className="flex justify-between gap-7 items-center">
                   <Typography as="li" color="white" className="cursor-pointer">
